...
resource "aws_eks_node_group" "nodes" {
  ...
  # Ensure that IAM Role permissions are created before and deleted after the EKS Node Group. Otherwise, EKS will not be able to properly dele EC2 Instances and Elastic Network Interfaces
  depends_on = [
